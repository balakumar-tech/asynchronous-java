...
public class ParkingLotDemo {
    ...
    public static void main(String[] args) {
        ...
        floor1.addSpot(new ParkingSpot("F2-M1", VehicleSize.MEDIUM));
        floor1.addSpot(new ParkingSpot("F2-M2", VehicleSize.MEDIUM));
        floor1.addSpot(new ParkingSpot("F2-M3", VehicleSize.MEDIUM));



        ParkingFloor floor3 = new ParkingFloor(3);
        floor1.addSpot(new ParkingSpot("F3-S1", VehicleSize.SMALL));
        floor1.addSpot(new ParkingSpot("F3-S2", VehicleSize.SMALL));
        floor1.addSpot(new ParkingSpot("F3-S3", VehicleSize.SMALL));
